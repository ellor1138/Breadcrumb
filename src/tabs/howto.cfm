		...
		<div class="tabbable tabs-left">
			...
			<div class="tab-content subcontent">
				<div class="tab-pane active" id="Breadcrumb2">
					<h4>Installation</h4>
					<p>Add the includeContent() function in your layout.cfm file.</p>
					<div class="well">
						&lt;div&gt;<br>
					...
					<div class="well">
						...
						&nbsp;&nbsp;&nbsp;filters(through="createBreadcrumb");<br>
						}
					</div>
				...
				<div class="tab-pane" id="Pagetitle2">
					<h4>Installation</h4>
					<p>Add the includeContent() function in the <strong>&lt;title&gt; &lt;/title&gt;</strong> tag in your layout.cfm file.</p>
					<div class="well">
						&lt;head&gt;<br>
